...
$email_recipients = "maajidz@yahoo.com";//<<=== enter your email address here
...
$email_subject = "New Message from a customer on BudgetBookScanning.com";

$enable_auto_response = true;//Make this false if you do not want auto-response.
...
$extra_info = "Customer's IP Address: ".$_SERVER['REMOTE_ADDR']."\n";

$email_body = "You have received a new Message on BudgetBookScanning.com . Details are below:\n$fieldtable\n $extra_info";
